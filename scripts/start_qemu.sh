...
${QEMU} -M arm-generic-fdt-plnx -machine linux=on -serial /dev/null -serial mon:stdio -display none -kernel $BUILDROOT/output/images/uImage -dtb $BUILDROOT/output/images/zynq-zc706.dtb --initrd $BUILDROOT/output/images/rootfs.cpio.uboot -net nic,vlan=0 -net user,vlan=0 -net nic,vlan=1 -net none,vlan=1 -net nic,vlan=2 -net tap,ifname=tap0,vlan=2 -append "mem=512M"
